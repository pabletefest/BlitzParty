...
{
    public class CheckHoleAvailabilityOnline : MonoBehaviour
    {
        
        private static CheckHoleAvailabilityOnline instance;
        public static CheckHoleAvailabilityOnline Instance => instance;
